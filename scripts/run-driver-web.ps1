...
Set-Location "E:\MyProjects\Cab Booking Service\apps\driver_app"
...
Write-Host "python -m http.server 4200 --bind 127.0.0.1 --directory `"E:\MyProjects\Cab Booking Service\apps\driver_app\build\web`"" -ForegroundColor Cyan
